...
/**************** WRITE HANDLE ****************/
/**
 * handle_write_char - Prints characters of a string
...
{ /* char is stored  at buffer's right */
	int f = 0;
	char padd = ' ';
...
/***************** WRITE NUMBER *********************/
/**
 * write_number - strings are prinnted by this function
 * @is_negative: Listeeldfn of arguments
 * @ind: char types.
 ...
 * @is_negative: Number the num is negative
 * @ind: Index at which the number st
...
/**
 * write_pointer - Write a memo
 * @buffer: Arrays of chars
 * @ind: Index ber starts in the buffer
 * @length: Length of number
 * @width: Wwidth specifier
 * @flags: Flags specifier
 * @padd: Char representing th
 * @extra_c: Char rep
